...
exports.holidays = exports.HolidayType = void 0;
var HolidayType;
(function (HolidayType) {
    HolidayType[HolidayType["WORKDAY"] = 0] = "WORKDAY";
    HolidayType[HolidayType["WEEKEND"] = 1] = "WEEKEND";
    HolidayType[HolidayType["HOLIDAY"] = 2] = "HOLIDAY";
    HolidayType[HolidayType["MAKEUP"] = 3] = "MAKEUP";
...
const dayjs = __importStar(__nccwpck_require__(401));
const timezone_1 = __importDefault(__nccwpck_require__(761));
const holiday_1 = __nccwpck_require__(946);
dayjs.extend(timezone_1.default);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        const date = new dayjs.Dayjs().tz('Asia/Shanghai');
        const dateKey = date.format('YYYY-MM-DD');
        let holiday = holiday_1.HolidayType.WORKDAY;
        if (holiday_1.holidays[dateKey] != null) {
            holiday = holiday_1.holidays[dateKey];
        }
        else if (date.day() === 0 || date.day() === 6) {
            holiday = holiday_1.HolidayType.WEEKEND;
        }
        switch (holiday) {
            case holiday_1.HolidayType.WEEKEND:
                core.setFailed(`Skip build: Weekend(${dateKey})`);
                break;
            case holiday_1.HolidayType.HOLIDAY:
                core.setFailed(`Skip build: Holiday(${dateKey})`);
                break;
            case holiday_1.HolidayType.WORKDAY:
                core.info(`Build: Workday(${dateKey})`);
                break;
            case holiday_1.HolidayType.MAKEUP:
